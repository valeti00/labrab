...
<br/><br/> После нужно было выбрать пункт "Консольное приложение" и нажать "Далее". Это показано на рисунке 2.<br/><br/>
...
Чтобы заккоментировать/раскомментировать блок кода, нужно воспользоваться комбинацией клавиш (Ctrl+K,Ctrl+C) Это показано на рисунке 8.
...
В программе "Microsoft Visual Studio" используется расширение "..vcproj".
...
<br/><br/><br/>
*Вывод:* Все цели и задачи лабораторной работы были выполнены в полном объеме. Были получены навыки в работе с Visual Studio на языке C++ и с языком разметки Markdown.
